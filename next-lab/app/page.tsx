...
const styleLink = "border-b-1 border-blue-500";

export default function Home() {
  return (
    <div className={styleContainer}>
      <div className="">
        <Link href="hello/" className={styleLink}>
          Hello
        </Link>
        <br />
        <Link href="hello/ivan" className={styleLink}>
          Hello Name
        </Link>
        <br />
        <Link href="ping" className={styleLink}>
          Ping
        </Link>
        <br />
        <Link href="dates" className={styleLink}>
          Dates
        </Link>
        <br />
        <Link href="rating" className={styleLink}>
          Rating
        </Link>
        <br />
        <Link href="axios" className={styleLink}>
          Axios
        </Link>
        <br />
        <Link href="anim" className={styleLink}>
          Anim
        </Link>
        <br />
